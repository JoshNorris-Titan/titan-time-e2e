...
# The dropdown itself is the named cbTabWeekConsultant. Env: TT_BASE_URL, TT_ROLE_PASS.
set -euo pipefail
...
tt_wait_for ".mx-name-cbTabWeekConsultant" "Sent tab consultant dropdown"

# Open the consultant dropdown and assert ascending order.
playwright-cli click ".mx-name-cbTabWeekConsultant" >/dev/null 2>&1
sleep 1
